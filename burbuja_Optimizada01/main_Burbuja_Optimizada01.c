...
{	
 ...
 imprimir_Arreglo(arr, n);
	...
	//******************************************************************	
	//Algoritmo de Ordenamiento: Burbuja Optimizada 01.
	/*
						...
						que la lista está ordenada. El funcionamiento principal es simil al de Burbuja Simple
            pero en este caso al final de cada iteración el elemento mayor queda situado en su posición,
            por lo tanto, ya no es necesario comparar con ningún otro número, reduciendo así el número
            de comparaciones por iteración.
	*/
	//******************************************************************
  ...
  ordenar_Arreglo(arr, n);
	...
	printf("\n*****Tiempos de ejecución del ordenamiento por Burbuja Optimizada 01 para n=%d*****\n", n);
